//! DUPLICATE, TEMPORARY. The live copy of this handler now lives at
//! `src/ros-launch-resolve/cli/src/check.rs` (layer 2, no ROS needed).
//! This copy stays only so play_launch keeps compiling until the CLI
//! verb reshape's Task 5 removes the `check` verb from this binary.
//! DELETE IT THERE — do not edit this file.
